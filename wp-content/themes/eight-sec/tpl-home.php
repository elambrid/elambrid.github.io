						...
						<div class="slide-caption">
							<div class="ed-container">
								...
								<div class="slide-content">
									...
									?>
										<a href="<?php the_permalink();?>" class="slide-readmore bttn"><?php echo esc_html($slider_readmore);?></a>
									<?php
										}
									?>
								</div>
			...
			<div class="ed-container">
				...
				if( !empty($about_page) && ($about_page != 0) ):?>
					<div class="section-title">
						<h2 class="about-sec wow fadeIn" data-wow-duration="2s"><?php echo esc_html($page_data->post_title);?></h2>
					</div>
			...
			<section id="<?php echo eight_sec_hyphenize($portfolio_menu);?>" class="eight_sec_plx_portfolio_section section">
				<div class="ed-container">
					...
					if( !empty($portfolio_page)  && ($portfolio_page != 0) ):?>
						<div class="section-title">
							<h2 class="portfolio-sec wow fadeIn" data-wow-duration="6s"><?php echo esc_html($portfolio_data->post_title);?></h2>
						</div>					
						<?php 
						if(!empty($portfolio_viewall)):?>
							<a class="portfolio-viewall bttn" href="<?php echo esc_url(get_category_link($portfolio_cat)); ?>"><?php echo esc_html($portfolio_viewall); ?></a>
						<?php endif;?>
			...
			<section id="<?php echo eight_sec_hyphenize($team_menu);?>" class="eight_sec_plx_team_section section">
				<div class="ed-container">
					...
					if( !empty($team_page) && ($team_page != 0) ):?>
						<div class="section-title">
							<h2 class="team-sec wow fadeIn" data-wow-duration="6s"><?php echo esc_html($team_data->post_title);?></h2>
						</div>
		...
		<section id="<?php echo eight_sec_hyphenize($cta_menu);?>" class="eight_sec_plx_cta_section section">
			<div class="ed-container">
				...
				<?php if(!empty($cta_button_text)):?>
					<a href="<?php echo $cta_button_link;?>" class="bttn cta-readmore wow fadeInUp" data-wow-duration="2s"><?php echo esc_html($cta_button_text);?></a>	
				<?php endif;?>
			</div>
		</section>
