...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'eight-sec' ); ?></a>
	<?php 
	...
	<header id="masthead" class="site-header <?php echo $ed_logo_alignment; ?>" role="banner">
		...
		<nav id="site-navigation" class="main-navigation <?php echo esc_attr($ed_nav_alignment);?>" role="navigation">
