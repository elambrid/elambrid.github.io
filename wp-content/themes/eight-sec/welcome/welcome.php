<?php
if(!class_exists('Eight_Sec_Welcome')) :

	class Eight_Sec_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					'getting_started' => esc_html__('Getting Started', 'eight-sec'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'eight-sec'),
					//'actions_required' => esc_html__('Required Plugins', 'eight-sec'),
					'demo_import' => esc_html__('Import Demo', 'eight-sec'),
					'support' => esc_html__('Support', 'eight-sec'),
					'changelog' => esc_html__('Changelog', 'eight-sec'),
					'more_wp' => esc_html__('More WordPress Stuff', 'eight-sec'),
				);
			...
			public function welcome_admin_notice_display(){
				...
				$eight_sec_an_div = '
				<div class="updated eight-sec-an notice notice-success is-dismissible">
				%1$s
				<hr/>
				<div class="eight-sec-column-wrap">
				<div class="eight-sec-column col-img">%2$s</div>
				<div class="eight-sec-column col-demos">%3$s</div>
				<div class="eight-sec-column col-doc">%4$s</div>
				</div> 
				</div>
				<style>%5$s</style>';

				/* translators: 1 - notice title, 2 - notice message */
				$eight_sec_an_top = sprintf(
					'<h2>%1$s</h2><p class="about-desc">%2$s</p></hr>',
					esc_html__( 'Congratulations!', 'eight-sec' ),
					sprintf(
						/* translators: %s - theme name */
						esc_html__( '%s is now installed and ready to use. We\'ve assembled some links to get you started.', 'eight-sec' ),
						$this->theme_name
					)
				);

				$eight_sec_an_btn = sprintf(
					/* translators: 1 - url, 2 - button text */
					'<a href="%1$s" class="button button-primary eight-sec-btn" >%2$s</a>',
					esc_url( admin_url( 'themes.php?page=welcome-page#demo_import' ) ),
					esc_html__( 'Try one of our ready to use Starter Sites', 'eight-sec' )
				);
				$eight_sec_an_pbtn = sprintf(
					...
					esc_html__( 'or go to the theme settings', 'eight-sec' )
				);
				$eight_sec_an_img = sprintf(
					'<picture>
				...
				$eight_sec_an_list = sprintf(
					'<div><h3><span class="dashicons dashicons-images-alt2"></span> %1$s</h3><p>%2$s</p></div><div> <p>%3$s</p><p>%4$s</p> </div>',
					__( 'Sites Library', 'eight-sec' ),
					// translators: %s - theme name
					sprintf( esc_html__( '%s now comes with a sites library with various designs to pick from. Visit our collection of demos that are constantly being added.', 'eight-sec' ), $this->theme_name ),
					$eight_sec_an_btn,
					$eight_sec_an_pbtn
				);
				$eight_sec_an_doc = sprintf(
					'<div><h3><span class="dashicons dashicons-format-aside"></span> %1$s</h3><p>%2$s</p><a class="button eight-sec-btn" href="%3$s">%4$s</a></div><div></div>',
					__( 'Documentation', 'eight-sec' ),
					// translators: %s - theme name
					sprintf( esc_html__( 'Need more details? Please check our full documentation for detailed information on how to use %s.', 'eight-sec' ), $this->theme_name ),
					'https://8degreethemes.com/documentation/eight-sec',
					esc_html__( 'Read full documentation', 'eight-sec' )
				);
				$eight_sec_an_style = '
				.eight-sec-an.notice.is-dismissible {padding: 20px 15px 5px;}
				.eight-sec-an hr {margin: 20px -23px 0;border-top: 1px solid #f3f4f5;border-bottom: none;}
				.eight-sec-an h3{margin: 17px 0 0;font-size: 16px;line-height: 1.4;}
				.eight-sec-an p {color: #72777c;}
				.eight-sec-an h2{margin: 0;font-size: 21px;font-weight: 400;line-height: 1.2;}
				.eight-sec-an p.about-desc{color: #72777c;font-size: 16px;margin: 0;padding:0px;}
				.eight-sec-column-wrap {display: -ms-grid;display: grid;-ms-grid-columns: 24% 32% 32%;grid-template-columns: 24% 32% 32%;margin-bottom: 13px;}
				.eight-sec-column {padding: 20px 40px 0 0;}
				.eight-sec-an .eight-sec-btn {padding: 30px;line-height: 0;}';
				...
				<div class="wrap about-wrap access-wrap">					
					<div class="top-block-wrap">					
						<div class="about-text">
							<h1><?php /* translators: %1$s: theme name, %2$s: theme version */ printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'eight-sec' ), esc_html($this->theme_name), esc_html($this->theme_version) ); ?></h1>
						...
						<div class="welcome-section-wrapper is_loading">
							...
							<div class="notice-sidebar is_loading">
								<div class= "notice-sidebar-item">
									<h4><?php echo esc_html('Join in our social networks!','eight-sec') ?></h4>
									<p><?php echo esc_html__('Get connected, share your opinions and more via our social community:', 'eight-sec'); ?></p>
									<p><a href="<?php echo esc_url('https://www.facebook.com/8DegreeThemes');?>"><?php echo esc_html('Join our Facebook Group','eight-sec') ?></a> <?php echo esc_html('- to receive updates, offers and more.','eight-sec') ?></p>
									<p><a href="<?php echo esc_url('https://www.youtube.com/8degreethemes');?>"><?php echo esc_html('Subscribe our YouTube Channel','eight-sec') ?></a> <?php echo esc_html('- for tutorials, videos and more.','eight-sec') ?></p>
									<p><a href="<?php echo esc_url('https://www.twitter.com/8degreethemes');?>"><?php echo esc_html('Follow us on Twitter','eight-sec') ?></a> <?php echo esc_html('- to stay updated.','eight-sec') ?></p>
								</div>
								<div class= "notice-sidebar-item">
									<h4><?php echo esc_html('Leave us a review','eight-sec') ?></h4>
									<p><?php echo esc_html__('Are you are enjoying WP Corporate? We would love to hear your feedback.', 'eight-sec'); ?></p>
									<a href="<?php echo esc_url('https://wordpress.org/support/theme/eight-sec/');?>"><?php echo esc_html('Submit a review','eight-sec') ?></a>
			...
			public function plugin_activation_callback() {
				...
				if(file_exists($plugin_file)) {
					...
					echo esc_html__('Plugin Does not Exists' , 'eight-sec');
				}
