...
function eight_sec_scripts() {
	...
	wp_enqueue_style( 'eight-sec-keybaord-style', get_template_directory_uri().'/css/keyboard.css', array(), '1.0.0' );	

	if( is_rtl() ){
		wp_enqueue_style( 'eight-sec-rtl', get_template_directory_uri(). '/rtl.css' );
	}
