<?php
	function eight_sec_customizer( $wp_customize ) {
	    ...
	    //Blog and archive Setting
		 ...
		 $wp_customize->add_panel(
	        'eight_sec_blog_archive_panel',
	        array(
	            'priority'      => 50,
	            'capability'    =>  'edit_theme_options',
	            'theme_supports'=>  '',
	            'title'         =>  esc_html__('Archive Settings','eight-sec'),
	            )
	        );
	    ...
	    $wp_customize->add_section(
	        ...
	        array(
	            ...
	            'priority'      =>  10,  
	            'panel'         =>  'eight_sec_blog_archive_panel'      
	            )
	        );
	        ...
	        $wp_customize->add_setting(
	            'eight_sec_team_archive_setting_readmore',
	            array(
	                'default'           =>  esc_html__('Read more','eight-sec'),
	                'sanitize_callback' =>  'sanitize_text_field',
	                )
	        ...
	        $wp_customize->add_control(
	            ...
	            array(
	                'priority'      =>  20,
	                'label'         =>  esc_html__('Team Read more text','eight-sec'),
	                'section'       =>  'eight_sec_blog_archive_setting',
	                'setting'       =>  'eight_sec_team_archive_setting_readmore',
	                'type'          =>  'text',  
	                )                                     
	            );

	        $wp_customize->add_setting(
	            'eight_sec_portfolio_archive_setting_readmore',
	            array(
	                'default'           =>  esc_html__('Read more','eight-sec'),
	                'sanitize_callback' =>  'sanitize_text_field',
	                )
	        ...
	        $wp_customize->add_control(
	            ...
	            array(
	                'priority'      =>  20,
	                'label'         =>  esc_html__('Portfolio Read more text','eight-sec'),
	                'section'       =>  'eight_sec_blog_archive_setting',
	                'setting'       =>  'eight_sec_portfolio_archive_setting_readmore',
	                'type'          =>  'text',  
	                )                                     
	            );
	    ...
	    $wp_customize->add_section(
	        'eight_sec_single_post_setting',
	        array(
	            'title'         =>  esc_html__('Single Post Setting','eight-sec'),
	            'description'   =>  esc_html__('Settings of Single Post','eight-sec'),
	            'priority'      =>  10,  
	            'panel'         =>  'eight_sec_blog_archive_panel'      
	            )
	        );
	    	...
	    	$wp_customize->add_setting(
		    	'eight_sec_post_featured_img_option', 
		    	array(
		      		'default' => 'enable',
		      		'capability' => 'edit_theme_options',
		   	...
		   	$wp_customize->add_control(
		   		...
		   		array(
			      	'type' => 'radio',
			      	'label' => esc_html__('Enable Disable Featured Image', 'eight-sec'),
			      	'section' => 'eight_sec_single_post_setting',
			      	'setting' => 'eight_sec_post_featured_img_option',
			      	'choices' => array(
	    ...
	    $wp_customize->add_panel(
            ...
            //search box
            $wp_customize->add_section(
			   	'eight_sec_header_setting_search', 
			   	array(
			       	'priority' => 20,
			       	'title' => esc_html__('Search Settings', 'eight-sec'),
			       	'panel' => 'eight_sec_header_setting'
					)
			   	);
			    ...
			    $wp_customize->add_setting(
			   	...
			   	$wp_customize->add_control('eight_sec_header_setting_search_options', array(
			      	...
			      	'section' => 'eight_sec_header_setting_search',
			    ...
			    $wp_customize->add_control(
			    	...
			    	array(
				        'type' => 'text',
			      		'label' => esc_html__('Search Box Placeholder', 'eight-sec'),
			      		'description' => esc_html__('Enter text to change placeholder text in header search box.', 'eight-sec'),
				        'section' => 'eight_sec_header_setting_search',
			    ...
			    $wp_customize->add_control(
			    	...
			    	array(
				        'type' => 'text',
			      		'label' => esc_html__('Search Button text', 'eight-sec'),
			      		'description' => esc_html__('Enter text to change button text in header search box.', 'eight-sec'),
				        'section' => 'eight_sec_header_setting_search',
