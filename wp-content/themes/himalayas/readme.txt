...
Himalayas WordPress Theme, Copyright 2015 ThemeGrill
Himalayas is distributed under the terms of the GNU GPL
...
* Fix - Header issue on safari
* Fix - Inner page toggle menu issue fixed.
* Feature - Submenu added
* Tweaks - Pages in widgets display by menu order and date.
...
* Portfolio placeholder popup error fixed.
* Added second layout of Call to Action.
* Default WordPress Gallery supported.
* Added second Footer layout.
